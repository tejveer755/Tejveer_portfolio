  ...
  return (
    (<div
      ...
      <div className="max-w-7xl flex flex-col items-end mx-auto  px-4 md:px-8 lg:px-10">
        ...
        <p className="text-xl text-gray-200 leading-relaxed max-w-xl text-right">
        ...
        {data.map((item, index) => (
          <div key={index} className="flex justify-start pt-10 md:pt-40 md:gap-10">
            <div
              ...
              <h3
                className="hidden md:block text-xl md:pl-20 md:text-5xl font-bold text-neutral-100  z-10 ">
                {item.title}
              </h3>
            </div>
