  ...
  return (
    (<div
      ...
      <div className="max-w-7xl flex flex-col items-end mx-auto  px-4 md:px-8 lg:px-10">
        ...
        <TextAnimation
          className="text-base lg:text-xl text-zinc-900 dark:text-gray-200 leading-relaxed max-w-xl text-center sm:text-right"
          text={"Driven by a passion for technology and innovation, I am committed to delivering solutions that are both functional and aesthetically refined. My work reflects a dedication to precision, problem-solving, and staying ahead in the fast-evolving digital landscape."} />
        ...
        {data.map((item, index) => (
          ...
          >
            <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
              ...
              <h3 className="hidden md:block text-xl md:pl-20 md:text-5xl font-bold text-neutral-800 dark:text-neutral-500 ">
                {item.title}
              </h3>
            </div>
